...
//===================================================================
		  ...
		  $P_CATEGORY_STATUS=$_POST['P_CATEGORY_STATUS'];
		  $P_CREATE_BY=$_POST['P_CREATE_BY'];
		 
		 $curs = oci_new_cursor($conn);

		 $REG = oci_parse($conn, 
		 "begin UJG_DATA_PROSESS.UJG_CATEGORY_TABLE_IN
		 (:CURDATA,
		 :P_CATEGORY_NAME,
		 :P_CATEGORY_STATUS,
		 :P_CREATE_BY
		...
		oci_bind_by_name($REG, ":P_CATEGORY_NAME", $P_CATEGORY_NAME, -1, SQLT_CHR);
		oci_bind_by_name($REG, ":P_CATEGORY_STATUS", $P_CATEGORY_STATUS, -1, SQLT_CHR);
