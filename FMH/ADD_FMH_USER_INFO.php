...
include 'conn.php';
	...
	if($_SERVER['REQUEST_METHOD'] === 'POST'){
		  ...
		  $P_TOLET_NAME="sa";
		  $P_USER_PASSWORD="asd";
		  $P_USER_PHONE="11330002";
		  $P_USER_EMAIL="adsgag";
		  $P_USER_REFER_NO="5/5/2019";
		  $P_USER_STATUS="5/5/2019";
		  $P_CREATE_BY="dsfg"; */
//===================================================================
		 ...
		 $REG = oci_parse($conn, 
		 "begin FMH_DATA_PROSESS.FMH_ADD_USER_INFO
		 (:CUR_DATA,
		 :P_USER_INFO_NAME,
		 :P_USER_PASSWORD,
		 :P_USER_PHONE,
		...
		oci_bind_by_name($REG, ":P_USER_INFO_NAME", $P_USER_NAME, -1, SQLT_CHR);
