...
//===================================================================
		  ...
		  $P_USER_REFER_NO_SP=$_POST['P_USER_REFER_NO_SP'];
		  $P_USER_POINT_SP=$_POST['P_USER_POINT_SP'];
		  $P_USER_STATUS_SP=$_POST['P_USER_STATUS_SP'];
		  $P_CREATE_BY_SP=$_POST['P_CREATE_BY_SP'];
		 ...
		 $REG = oci_parse($conn, 
		 "begin OAA_PROSESS_DATA.OAA_INSERT_NEW_USER_SP
		 (:CURDATA,
		 :P_USER_INFO_NAME_SP,
		 :P_LOCATION_CODE,
		 :P_USER_FAST_NAME_SP,
		...
		oci_bind_by_name($REG, ":P_USER_REFER_NO_SP", $P_USER_REFER_NO_SP, -1, SQLT_CHR);
		oci_bind_by_name($REG, ":P_USER_POINT_SP", $P_USER_POINT_SP, -1, SQLT_CHR);
		oci_bind_by_name($REG, ":P_USER_STATUS_SP", $P_USER_STATUS_SP, -1, SQLT_CHR);
		oci_bind_by_name($REG, ":P_CREATE_BY_SP", $P_CREATE_BY_SP, -1, SQLT_CHR);
